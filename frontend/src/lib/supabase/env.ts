...
/**
 * Demo catalog (mockProviders) is allowed only in local development
 * when Supabase is not configured. Production never shows invented profiles.
 */
export function allowMockCatalog(): boolean {
